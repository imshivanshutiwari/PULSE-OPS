...
_ALL_VERSIONS = {
    ...
    "g-v1": {
        "model": "german_credit/neural_net",
        "version": "v1.3",
        "stage": "archived",
        "accuracy": 0.798,
        "f1": 0.782,
    ...
    def display_node_detail(node_data):
            ...
            row_els.append(
                html.Div(
                    [
                        ...
                        html.Span(
                            value, style={"color": v_color, "fontFamily": FONT, "fontSize": "10px"}
                        ),
                    ],
        ...
        return html.Div(
            ...
            style={
                ...
                "border": f"1px solid {stage_color}",
                "borderRadius": "3px",
                "padding": "10px",
            },
        )
