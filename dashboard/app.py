                ...
                dcc.Checklist(
                    ...
                    options=[
                        ...
                        },
                        {
                            "label": html.Span(
                                "Staging",
                                style={"color": INFO, "fontFamily": FONT, "fontSize": "11px"},
                            ),
                            "value": "staging",
                        },
                        {
                    ...
                    [
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                ...
                                {
                                    "label": "bike_sharing/lightgbm",
                                    "value": "bike_sharing/lightgbm",
                                },
                                {
                                    "label": "german_credit/neural_net",
                                    "value": "german_credit/neural_net",
                                },
                            ],
                            value="bike_sharing/lightgbm",
                            clearable=False,
...
def render_tab(tab):
    ...
    return html.Div(
        "Select a tab", style={"color": TEXT_DIM, "fontFamily": FONT, "padding": "20px"}
    )
